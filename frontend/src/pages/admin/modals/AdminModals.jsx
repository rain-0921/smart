...
export function AdminUserModal({ editingUser, userForm, instructors, onChange, onClose, onSubmit }) {
  return (
    <Modal title={editingUser ? 'Edit User' : 'Add New User'} onClose={onClose}>
      {[
        ...
        <div key={f.key} style={{ marginBottom: 12 }}>
          ...
          <input className="adm-input" style={formInput} type={f.type} value={userForm[f.key]}
            onChange={e => onChange({ ...userForm, [f.key]: e.target.value })} />
        </div>
      ))}
      <div style={{ marginBottom: 12 }}>
        <label style={formLabel}>Role</label>
        <select className="adm-input" style={formInput} value={userForm.role} onChange={e => onChange({ ...userForm, role: e.target.value })}>
      ...
      {editingUser && (
        <div style={{ marginBottom: 12 }}>
          ...
          <select className="adm-input" style={formInput} value={userForm.status} onChange={e => onChange({ ...userForm, status: e.target.value })}>
        ...
        <>
          <div style={{ marginBottom: 12 }}>
            ...
            <select className="adm-input" style={formInput} value={enrollEditForm.user_id}
              onChange={e => onChangeEdit({ ...enrollEditForm, user_id: e.target.value })} disabled>
          ...
          <div style={{ marginBottom: 12 }}>
            ...
            <select className="adm-input" style={formInput} value={enrollEditForm.course_id}
              onChange={e => onChangeEdit({ ...enrollEditForm, course_id: e.target.value })}>
